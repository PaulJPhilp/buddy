...
## Development Server
- Never run the development server automatically
- Always wait for explicit user instruction before starting the server
- If server needs to be started, provide the command for the user to run themselves
...
### Key Points
- PostCSS plugin is in a separate package
- Configuration is more modular
- Better separation of concerns
- Improved maintainability

### Migration Notes
- Using `@tailwindcss/postcss` instead of `tailwindcss` directly
- PostCSS plugin is now a separate package
