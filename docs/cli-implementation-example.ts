// CLI Implementation Example for Buddy Workspace Management
// This demonstrates the Direct CLI approach with local file storage and WebSocket sync
...
// Usage examples:
//
// bun run buddy-workspace-cli.ts workspace create "My Project" --icon "🚀" --color "#ff6b35"
// bun run buddy-workspace-cli.ts workspace list --format json
// bun run buddy-workspace-cli.ts workspace show workspace-my-project-123
// bun run buddy-workspace-cli.ts workspace activate workspace-my-project-123
// bun run buddy-workspace-cli.ts workspace current
// bun run buddy-workspace-cli.ts workspace active
// bun run buddy-workspace-cli.ts config show
// bun run buddy-workspace-cli.ts config set format json
