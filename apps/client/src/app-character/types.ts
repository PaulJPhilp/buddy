...
export interface CharacterService {
    ...
    updateStatus(id: string, status: Partial<Character["status"]>): Effect.Effect<never, Error, Character>
    updateCapabilities(id: string, capabilities: Partial<Character["capabilities"]>): Effect.Effect<never, Error, Character>
