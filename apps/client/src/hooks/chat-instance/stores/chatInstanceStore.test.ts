...
import { chatInstanceActions, chatInstanceSelectors, chatInstanceStore } from './chatInstanceStore';
...
describe('chatInstanceStore', () => {
    ...
    test('should clear messages', () => {
        ...
        const message1: Message = { id: 'msg1', text: 'Hello', role: 'user', timestamp: Date.now() };
        const message2: Message = { id: 'msg2', text: 'Hi there', role: 'assistant', timestamp: Date.now() };
